...
import { FileText, Clock, MapPin, Edit3 } from "lucide-react";
...
export default function AdmitCardForm({ onSubmit, isLoading }) {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="bg-white dark:bg-slate-900 p-6 rounded-xl shadow-sm border border-slate-200 dark:border-slate-800 transition-colors">
      ...
      <div className="mt-6 flex justify-end">
        ...
        >
          ...
          {isLoading ? "Fetching Students..." : "Generate Admit Cards"}
        </button>
      </div>
    </form>
  );
